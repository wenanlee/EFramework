...
namespace EFramework.Unity.Node
{
	...
	public class BaseNodeView : NodeView
	{
		...
		private List<UnityEditor.Experimental.GraphView.Node> selectedNodes = new List<UnityEditor.Experimental.GraphView.Node>();
		...
		{
			selectedNodes = new List<UnityEditor.Experimental.GraphView.Node>();
		...
		public static Rect GetNodeRect(UnityEditor.Experimental.GraphView.Node node, float left = int.MaxValue, float top = int.MaxValue)
		{
			return new Rect(
