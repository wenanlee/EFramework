...
namespace NaughtyAttributes.Test
{
    public class ProgressBarTest : MonoBehaviour
    {
        ...
        [NaProgressBar("Health", 100, EColor.Red)]
        ...
        [NaProgressBar("Elixir", "maxElixir", color: EColor.Violet)]
    ...
    {
        [NaProgressBar("Mana", 100, EColor.Blue)]
    ...
    {
        [NaProgressBar("Stamina", 100, EColor.Green)]
