...
public static class Debuger
{
    ...
    public static string LogFileDir = AppDomain.CurrentDomain.BaseDirectory + "/DebugerLog/";
    public static string LogFileName = "Log.txt";
    public static string Prefix = "> ";
    public static StreamWriter LogFileWriter = null;
#if UNITY_EDITOR || UNITY_STANDALONE || UNITY_ANDROID
    private static IDebugerConsole m_console = new UnityDebugerConsole();
#else
    private static IDebugerConsole m_console = new SystemColorConsole();
#endif
